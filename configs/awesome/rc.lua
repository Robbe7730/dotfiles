...
globalkeys = mytable.join(
    ...
    -- Play/Pause
    awful.key({ modkey }, "p", function () os.execute("playerctl --ignore-player=firefox play-pause") end,
              {description = "play/pause song", group = "hotkeys"}),

    -- X screen locker
    awful.key({ }, "Print", function () os.execute(printscrn) end,
              {description = "Printscreen", group = "hotkeys"}),
    ...
    -- Screen brightness
    awful.key({ }, "XF86MonBrightnessUp", function () os.execute("brightnessUp") end,
              {description = "Increase Brightness", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("brightnessDown") end,
